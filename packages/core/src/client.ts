...
// Health probes run inside host context events, where the event loop may be
...
// different proxies (per-project config / HEADROOM_PROXY_URL), and one URL's
// verdict must never answer for another.
